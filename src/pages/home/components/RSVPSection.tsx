...
import rsvpTriangle from '@/assets/rsvpTriangle.png';
...
const ContactBox: React.FC<ContactBoxProps> = ({ phone, name, img }) => (
  <div className="border-cream-200/40 bg-dela-kolor-tla-kafelek-rsvp group hover:bg-wine-800/40 hover:border-cream-200/60 relative flex flex-col items-center justify-center space-y-6 border p-10 backdrop-blur-sm transition-all duration-500 lg:p-14">
  ...
  return (
    <section className="relative w-full overflow-hidden px-4 py-24">
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center">
        ...
        <img className="mb-5 size-20" src={rsvpTriangle} />
